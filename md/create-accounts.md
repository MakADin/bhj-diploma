...
7. *renderItems* отрисовывает элементы счётов в боковой колонке.
...
2. Для каждого элемента в полученном массиве счетов вызывает метод *renderItem()*
...
необходимо сформировать HTML-код всех счетов
с помощью метода *getAccountHTML*
и отобразить их в панели счетов